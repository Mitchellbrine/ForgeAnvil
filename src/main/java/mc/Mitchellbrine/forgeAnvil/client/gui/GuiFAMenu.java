...
import mc.Mitchellbrine.forgeAnvil.core.ModInfo;
...
public class GuiFAMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        String s2 = "Forge Anvil ("+ ModInfo.VERSION + ") by the ForgeAnvil Team";
